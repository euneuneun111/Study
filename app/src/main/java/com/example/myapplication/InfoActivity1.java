...
public class InfoActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diseaseSymptomsTextView = findViewById(R.id.disease_food);
        diseaseFoodTextView = findViewById(R.id.disease_department);
        diseaseDepartmentTextView = findViewById(R.id.disease2);
        diseaseCauseTextView = findViewById(R.id.disease4);
        ...
        findViewById(R.id.confirm_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(InfoActivity1.this, "", Toast.LENGTH_SHORT).show();
                finish();  // 현재 액티비티 종료
            }
        });
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            ...
            if (id == R.id.nav_board) {
                startActivity(new Intent(InfoActivity1.this, BoardActivity.class));
                return true;
            } else if (id == R.id.nav_home) {
                startActivity(new Intent(InfoActivity1.this, BoardActivity.class));
                return true;
            } else if (id == R.id.nav_profile) {
                startActivity(new Intent(InfoActivity1.this, ProfileActivity.class));
                return true;
            }
            return false;
        });
