...
public class LungActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout Lung_check = findViewById(R.id.lung_check);
        LinearLayout Lung_add = findViewById(R.id.lung_add);
        ...
        Lung_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bestPrediction != null) {
                    Intent intent = new Intent(LungActivity.this, ResultActivity.class);
                    intent.putExtra("resultText", "사용자님은 '" + bestPrediction + "' 증상이 의심됩니다 유사성은 " + String.format("%.2f", bestSimilarity) + "% 입니다.");
                    startActivity(intent);
                } else {
                    Toast.makeText(LungActivity.this, "이미지를 먼저 선택하세요.", Toast.LENGTH_SHORT).show();
                }
                // 클릭 시 실행할 동작
            }
        });
