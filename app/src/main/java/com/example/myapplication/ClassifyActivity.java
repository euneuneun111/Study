...
public class ClassifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e("TFLite", "Model loading failed: " + e.getMessage());
        ...
        checkResultButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (bestPrediction != null) {
                    Intent intent = new Intent(ClassifyActivity.this, ResultActivity.class);
                    intent.putExtra("resultText", "사용자님은 '" + bestPrediction + "' 증상이 의심됩니다 유사성은 " + String.format("%.2f", bestSimilarity) + "% 입니다.");
                    startActivity(intent);
                } else {
                    Toast.makeText(ClassifyActivity.this, "이미지를 먼저 선택하세요.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
